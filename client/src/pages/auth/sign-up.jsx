        ...
        <form className="w-full mx-auto" onSubmit={handleSignUp}>
          <div className="flex flex-col gap-6 mb-4">
            {[{
              ...
              type: "password"
            }].map(({ label, placeholder, value, setValue, type }, idx) => (
              <motion.div key={idx} variants={itemVariants}>
                <Typography variant="small" color="blue-gray" className="mb-1.5 font-medium text-gray-700">
                  {label}
                </Typography>
                <Input
                  type={type}
                  ...
                  className="border border-blue-gray-200 focus:border-indigo-500 rounded-lg px-4 py-3 text-gray-900 bg-white placeholder-gray-500"
